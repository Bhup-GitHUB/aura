...
export const DashboardPreview: React.FC = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="py-24 bg-luxury-black overflow-hidden relative perspective-[2000px]"
    >
      ...
      <div className="container mx-auto px-4 text-center mb-16">
        <span className="text-luxury-gold text-xs font-bold tracking-[0.3em] uppercase mb-4 block">
          The MarketVision Dashboard
        </span>
        <h2 className="text-3xl md:text-5xl font-serif text-white">
          Deep intelligence on <br />
          Indian Real Estate.
        </h2>
      </div>
          ...
          <div className="absolute top-0 left-0 right-0 h-14 bg-[#1a1a1a] border-b border-white/5 flex items-center justify-between px-6 z-20">
            <div className="flex items-center gap-4">
              ...
              <span className="text-white font-serif tracking-wider text-sm">
                AURA{" "}
                <span className="text-luxury-gold text-[10px] align-top">
                  VISION
                </span>
              </span>
            </div>
            ...
            <div className="flex-1 max-w-md mx-8 hidden md:block">
              <div className="relative">
                ...
                <input
                  type="text"
                  disabled
                  placeholder="Search location (e.g. Bandra West, Worli)..."
                  className="w-full bg-[#0a0a0a] border border-white/5 rounded-full py-1.5 pl-9 pr-4 text-xs text-gray-300 focus:outline-none"
                />
              </div>
            </div>
            ...
            {[
              ...
              <div
                ...
                className={`flex items-center gap-3 px-6 py-3 cursor-pointer transition-colors ${
                  item.active
                    ? "bg-luxury-gold/10 border-r-2 border-luxury-gold"
                    : "hover:bg-white/5 border-r-2 border-transparent"
                }`}
              >
                <item.icon
                  size={16}
                  className={item.active ? "text-luxury-gold" : "text-gray-500"}
                />
                <span
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
              <div className="dash-widget md:col-span-2 bg-[#141414] border border-white/5 rounded-lg p-6 relative overflow-hidden group">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-white text-sm font-medium">
                      Price Trends: Bandra West
                    </h3>
                    <p className="text-gray-500 text-[10px] uppercase tracking-wider mt-1">
                      Avg. ₹/Sq. Ft.
                    </p>
                  </div>
                  <span className="text-green-400 text-xs flex items-center gap-1 bg-green-400/10 px-2 py-1 rounded">
                    +8.2% YoY
                  </span>
                </div>
                ...
                <div className="relative h-32 w-full mt-8">
                  ...
                  >
                    <path
                      d="M0,100 C50,90 100,110 150,80 C200,50 250,90 300,60 C350,30 400,40 450,20 L450,120 L0,120 Z"
                      fill="url(#gradient)"
                      opacity="0.2"
                    />
                    <path
                      d="M0,100 C50,90 100,110 150,80 C200,50 250,90 300,60 C350,30 400,40 450,20"
                      fill="none"
                      stroke="#D9A441"
                      strokeWidth="2"
                    />
                  ...
                  <div className="absolute top-[5%] left-[60%] bg-white text-black text-[10px] font-bold px-2 py-1 rounded transform -translate-x-1/2">
                    ₹65,000/sqft
                  </div>
                </div>
              </div>
              ...
              <div className="dash-widget bg-[#141414] border border-white/5 rounded-lg p-6 flex flex-col relative">
                ...
                <div className="flex-1 flex flex-col justify-center items-center my-2">
                  <div className="relative w-32 h-16 overflow-hidden mb-2">
                    <div
                      className="absolute top-0 left-0 w-full h-32 border-[12px] border-gray-800 rounded-full box-border border-b-0 border-l-0 border-r-0"
                      style={{
                    ...
                    ></div>
                    <div
                      className="absolute top-0 left-0 w-full h-32 border-[12px] border-transparent border-t-luxury-gold rounded-full box-border"
                      style={{
                ...
                <div className="bg-white/5 rounded-md p-3 border-l-2 border-green-500 mt-auto">
                  <p className="text-gray-300 text-[10px] leading-relaxed">
                    <span className="text-green-400 font-bold">Analysis:</span>{" "}
                    Property is priced 4% below micro-market average for Pali
                    Hill. Good buy.
                  </p>
                </div>
              </div>
              ...
              <div className="dash-widget md:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-4 mt-auto">
                {[
                  ...
                  {
                    label: "Projected 5Y Growth",
                    value: "+42%",
                    sub: "High Growth Zone",
                  },
                  {
                  ...
                  <div
                    key={i}
                    className="bg-[#141414] border border-white/5 rounded-lg p-4 hover:border-white/20 transition-colors"
                  >
