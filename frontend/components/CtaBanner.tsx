        ...
        <div className="glass-panel p-12 md:p-24 rounded-sm border border-white/10 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-lg font-light">
              Join India's smartest property investors and stop overpaying for real estate today.
            </p>
          </div>
          
          <div className="flex-shrink-0">
            <Button variant="primary" className="min-w-[200px]">Get Market Report</Button>
          </div>
        </div>
      </div>
    </section>
