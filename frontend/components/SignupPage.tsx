...
export const SignupPage: React.FC<NavigationProps> = ({ onNavigate }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen w-full bg-luxury-black flex items-center justify-center relative overflow-hidden px-6 py-12"
    >
      ...
      >
        <div className="hidden lg:block pr-12">
          ...
          <p className="text-gray-400 font-light text-lg mb-12 max-w-md">
            Aura is currently invite-only for select brokerages. Apply now to
            join our waitlist or activate your brokerage invite code.
          </p>
